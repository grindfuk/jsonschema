...
var ValidationError = exports.ValidationError = function ValidationError (message, instance, schema, propertyPath, throwAsError) {
  if (propertyPath) {
...
ValidatorResult.prototype.addError = function addError(message) {
  var err = new ValidationError(message, this.instance, this.schema, this.propertyPath, this.throwError);
  if (this.throwError) {
    // Quickly make this an instance of error object.
    err.__proto__ = Object.create(Error.prototype)  
    throw err;
  }
